...
require (
	...
	github.com/openshift/assisted-installer v1.0.10-0.20220509070428-e9b24b7baaa6
	github.com/openshift/assisted-installer-agent v1.0.10-0.20220504213613-71823d6d96a1
