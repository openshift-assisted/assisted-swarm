...
import (
	...
	"github.com/openshift-assisted/assisted-swarm/restapi/operations/swarm"
	"github.com/openshift-assisted/assisted-swarm/src/agents"
	"github.com/openshift-assisted/assisted-swarm/src/factories"
...
func (s *SwarmAPI) Exit(ctx context.Context, params swarm.ExitParams) middleware.Responder {
	go func() {
		// Sleep to let us return reply to client before termination
